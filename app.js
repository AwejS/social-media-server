...
cloudinary.config({
	cloud_name: "djobxuf5f",
	api_key: "357228622566314",
	api_secret: "CX7hHCnunFHX0n5xcQKog6i0NhE",
});
...
const start = async () => {
	try {
		await connectDB("mongodb+srv://awej4217:qazwsxedc@mernsocialapp.6fz9txg.mongodb.net/mernSocialApp?retryWrites=true&w=majority");
